...
def clean_release_date(raw_release_date):
	"""
	...
	"""
	raw_release_date = raw_release_date.lower()
	filters = ['nd', 'ust', 'st', 'th', 'rd', ',', '.']
	for string in filters:
		if string in raw_release_date:
			raw_release_date = raw_release_date.replace(string, '')

	return raw_release_date.capitalize()
